<div class="sidebar shadow">
    ...
    <div class="main">
        <ul>
            ...
            <li>
                <a href="{{ url('/admin/products/1') }}" class="lk-products lk-product_add lk-product_search lk-product_edit lk-product_gallery_add"><i class="fa-solid fa-boxes-stacked"></i>Productos</a>
            </li>
            @endif
            ...
            <li>
                <a href="{{ url('/admin/users/all') }}" class="lk-user_list lk-user_edit"><i class="fa-solid fa-user-group"></i></i>Usuarios</a>
            </li>
            @endif
        </ul>
